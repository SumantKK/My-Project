...
def get_insulin_details(brand_name):
    insulin_details = {
        ...
        'Ascolite': {'Insulin Name': 'Ascolite Fixobond Polymer Modified Tile Adhesive', 'Insulin Type':'Mumbai North', 'Dosage Strength': 'High', 'Price (INR)': 630},
        ...
        'Myk': {'Insulin Name': 'Myk Laticrete L-325 High Flex White', 'Insulin Type': 'Mumbai North', 'Dosage Strength': 'Low', 'Price (INR)': 760},
        ...
        'Sika': {'Insulin Name': 'Sika Ceram 255 Large Tile Adhesive', 'Insulin Type': 'Mumbai North', 'Dosage Strength': 'Low', 'Price (INR)': 610},
